...
public interface YearbookManagerRepository extends JpaRepository<YbYearbookManager, UUID> {
    List<YbYearbookManager> findByYearbookId(UUID yearbookId);
    void deleteByYearbookId(UUID yearbookId);
    boolean existsByYearbookIdAndUserId(UUID yearbookId, UUID userId);
}
